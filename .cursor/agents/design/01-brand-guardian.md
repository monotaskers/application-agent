...
_Brand Compliance Enforcer with Autonomous Validation_
...
- `docs/design/design-principles.md` - Core design standards
...
grep -n "Strictness:" docs/design/design-principles.md
```
...
_Brand Guardian v1.0_  
_Part of Design Agent System_  
_Save to: `.cursor/agents/design/01-brand-guardian.md`_
