  ...
  "cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-background text-foreground border border-input hover:bg-muted/50 data-[state=open]:bg-muted/50",
        dashed:
          "text-foreground border border-input border-dashed bg-background hover:bg-primary/10 data-[state=open]:bg-primary/10",
        ghost:
          "text-foreground hover:bg-muted/50 hover:text-foreground data-[state=open]:bg-muted/50 data-[state=open]:text-foreground",
    ...
    compoundVariants: [
      ...
      // Ghost
      {
        ...
        appearance: "ghost",
        className:
          "bg-transparent text-foreground hover:bg-muted/50 data-[state=open]:bg-muted/50",
      },
      {
        variant: "destructive",
        appearance: "ghost",
...
/**
 * Button component with multiple variants, sizes, and modes.
 *
