...
const tabsListVariants = cva("flex items-center shrink-0", {
  variants: {
    variant: {
      ...
      button: "border border-border rounded-lg p-1 bg-muted",
  ...
  "shrink-0 cursor-pointer whitespace-nowrap inline-flex justify-center items-center font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&:hover_svg]:text-primary [&[data-state=active]_svg]:text-primary",
  {
    variants: {
      variant: {
        ...
        button:
          "flex-1 border border-transparent bg-transparent focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-background/50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:border-border data-[state=active]:shadow-sm",
    ...
    compoundVariants: [
      ...
      { variant: "button", size: "lg", className: "py-2.5 px-6 rounded-md" },
      { variant: "button", size: "md", className: "py-2 px-5 rounded-md" },
      { variant: "button", size: "sm", className: "py-1.5 px-4 rounded-md" },
      { variant: "button", size: "xs", className: "py-1 px-3 rounded-sm" },
