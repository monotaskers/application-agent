...
const badgeVariants = cva(
  "inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "bg-[var(--color-primary-500)] border-[var(--color-primary-500)] text-white dark:bg-[var(--color-primary-500)] dark:border-[var(--color-primary-500)] dark:text-white",
        secondary:
          "bg-[var(--color-primary-400)] border-[var(--color-primary-400)] text-white dark:bg-[var(--color-primary-400)] dark:border-[var(--color-primary-400)] dark:text-white",
        success:
          "bg-[var(--color-success-accent,var(--color-green-500))] border-[var(--color-success-accent,var(--color-green-500))] text-[var(--color-success-foreground,var(--color-white))]",
        warning:
          "bg-[var(--color-warning-accent,var(--color-yellow-500))] border-[var(--color-warning-accent,var(--color-yellow-500))] text-[var(--color-warning-foreground,var(--color-white))]",
        info: "bg-[var(--color-info-accent,var(--color-violet-500))] border-[var(--color-info-accent,var(--color-violet-500))] text-[var(--color-info-foreground,var(--color-white))]",
        outline:
          "bg-[var(--color-primary-100)] border-[var(--color-primary-100)] text-[var(--color-primary-700)] dark:bg-[var(--color-primary-900)] dark:border-[var(--color-primary-900)] dark:text-[var(--color-primary-300)]",
        destructive:
          "bg-[var(--color-primary-600)] border-[var(--color-primary-600)] text-white dark:bg-[var(--color-primary-600)] dark:border-[var(--color-primary-600)] dark:text-white",
      },
      appearance: {
        default: "",
        light: "",
    ...
    compoundVariants: [
      /* Light */
      {
        ...
        appearance: "light",
        className:
          "text-[var(--color-primary-700)] border-[var(--color-primary-100)] bg-[var(--color-primary-100)] dark:bg-[var(--color-primary-900)] dark:border-[var(--color-primary-900)] dark:text-[var(--color-primary-300)]",
      },
      {
        variant: "secondary",
        appearance: "light",
      ...
      /* Outline */
      {
        ...
        appearance: "outline",
        className:
          "text-[var(--color-primary-700)] border-[var(--color-primary-50)] bg-[var(--color-primary-50)] dark:bg-[var(--color-primary-900)] dark:border-[var(--color-primary-900)] dark:text-[var(--color-primary-300)]",
      },
      {
        variant: "success",
        appearance: "outline",
